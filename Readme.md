...
This is the main repository for the source code of the project "A RISC-V based Linear Algebra accelerator for SoC designs", which was done as part of the EE2003 course in IIT Madras. 
